...
import { Runnable, Runner } from 'mocha';
import mochaJsonDeserialize from 'mocha-json-deserialize';

const { STATE_FAILED, STATE_PASSED } = Runnable.constants;
const {
  EVENT_RUN_BEGIN,
  EVENT_RUN_END,
  EVENT_SUITE_BEGIN,
 ...
 */
class MochaJsonRunner extends Runner {
...
export default MochaJsonRunner;
